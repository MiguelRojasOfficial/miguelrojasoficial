    ...
    <div className="instruction-container">
      <div className="instruction-box">
        ...
        <p className="instruction-note">
          {lang === 'es'
            ? <>Busca nuestros cinco aeropuertos de destino.<br />Mantén presionada la <strong>flecha arriba</strong> para despegar.<br/>El avión subirá automáticamente después de unos segundos.</>
            : <>Search for our five destination airports.<br />Hold the <strong>Up Arrow</strong> key to take off.<br/>The plane will lift automatically after a few seconds.</>}
        </p>
